...
\begin{figure}
	\begin{tikzpicture}
		\begin{axis}[
			...
			coordinates {
				(500, 0.077335)(1000, 0.356616)(1500, 0.972417)
			};
			...
			coordinates {
				(500, 0.000704)(1000, 0.002767)(1500, 0.010061)
			};
			\addlegendentry{Библиотека OpenBlas}
			...
			coordinates {
				(500, 0.001631)(1000, 0.008432)(1500, 0.048598)
			};
			\addlegendentry{Библиотека MKL}
			
		\end{axis}
	\end{tikzpicture}
	\caption{Задание 3 - Зависимость времени выполнения умножения матриц от количества процессов для разных реализаций}
\end{figure}
