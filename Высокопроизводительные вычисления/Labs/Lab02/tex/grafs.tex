...
\begin{figure}
	\begin{tikzpicture}
		\begin{axis}[
			...
			coordinates {
				(500, 0.001090)(1000, 0.002711)(1500, 0.005059)
			};
			\addlegendentry{Unified Memory}
			...
			coordinates {
				(500, 0.000894)(1000, 0.004118)(1500, 0.008561)
			};
			\addlegendentry{Global Memory}
			
		\end{axis}
	\end{tikzpicture}
	\caption{Задание 2b - Зависимость времени выполнения умножения матриц от размера матриц и типа памяти}
\end{figure}
...
\begin{figure}
	\begin{tikzpicture}
		...
		\end{axis}
	\end{tikzpicture}
	\caption{Задание 2b - Зависимость GFLOPS умножения матриц от размера матриц и типа памяти}
\end{figure}
...
\begin{figure}
	\begin{tikzpicture}
		\begin{axis}[
			...
			coordinates {
				(500, 0.000017)(1000, 0.000032)(1500, 0.000047)
			};
			...
			coordinates {
				(500, 0.000014)(1000, 0.000027)(1500, 0.000039)
			};
			\addlegendentry{Shared Memory T\_N = 16, S\_N=24}
...
\begin{tikzpicture}
	\begin{axis}[
		...
		coordinates {
			(500, 14363.669140)(1000, 62555.175512)(1500, 142236.444037)
		};
		\addlegendentry{Shared Memory THREADS\_N = 16}
		...
		coordinates {
			(500, 17356.097675)(1000, 75459.760230)(1500, 171002.437077)
		};
		\addlegendentry{Shared Memory T\_N = 16, S\_N=24}
...
\begin{figure}
	\begin{tikzpicture}
		\begin{axis}[
			...
			coordinates {
				(500, 0.008236)(1000, 0.015366)(1500, 0.022880)
			};
			...
			coordinates {
				(500, 0.001069)(1000, 0.004611)(1500, 0.013671)
			};
			\addlegendentry{OpenMP teams}
